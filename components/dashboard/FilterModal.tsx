...
import { Education, MaritalStatus, Intention } from "@/lib/mock-data";
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <select 
                ...
                onChange={(e) => setFilters({...filters, maritalStatus: e.target.value as MaritalStatus})}
           ...
           <div className="space-y-4">
            ...
            <select 
                className="w-full h-14 rounded-xl border border-gray-300 px-4 text-lg bg-white"
                onChange={(e) => setFilters({...filters, education: e.target.value as Education})}
