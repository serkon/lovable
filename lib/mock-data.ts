...
export type EducationId =
  ...
  | "edu_middleschool"
  | "edu_elementary";
export const EDUCATIONS: EducationId[] = [
  "edu_phd",
  "edu_masters",
  "edu_bachelors",
  "edu_associates",
...
export const MOCK_PROFILES: Profile[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1542596768-5d1d21f1cfb6?auto=format&fit=crop&q=80&w=800&h=1000",
...
export const MOCK_LIKED_BY_PROFILES: Profile[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=800&h=1000", // Reusing image for demo
