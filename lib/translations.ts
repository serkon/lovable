...
export const translations = {
  tr: {
    ...
    profile_photos: "PROFİL FOTOĞRAFLARI",
    profile_photos_desc: "Profilinizi tamamlamak için dilediğiniz kadar fotoğraf ekleyebilirsiniz.",
    n_photos: "{count} Fotoğraf",
    main_photo: "ANA FOTOĞRAF",
    photo_tips_title: "MÜKEMMEL FOTOĞRAF TÜYOLARI",
    tip_light: "İyi Işık",
    tip_solo: "Yalnız Çekim",
    tip_face: "Net Yüz",
    basic_info_title: "KİMLİK BİLGİLERİ",
    contact_info_title: "İLETİŞİM BİLGİLERİ",
    more_details_title: "BİRAZ DAHA DETAY",
    intention_title: "TANIŞMA AMACI",
    about_me_title: "KENDİNİZDEN BAHSEDİN",
    ai_suggestions_title: "YAPAY ZEKA ÖNERİLERİ",
    hobbies_title: "İLGİ ALANLARI VE HOBİLER",
    ...
    btn_set_primary: "Ana Yap",
    ai_analysis: "AI Görsel Analizi",
    error_upload_failed: "Görsel yüklenemedi. Lütfen tekrar deneyin.",
    ...
    location_help_text: "Sana en yakın kişileri bulmamıza yardımcı ol.",
    location_not_set: "Konum belirtilmedi",
    location_detected: "Konum ayarlandı!",
    location_error: "Konum henüz ayarlanamadı.",
    ...
    password_req_uppercase: "Büyük harf",
    password_req_number: "Rakam",
    password_req_special: "Özel karakter",
    photo_cover: "Kapak Fotoğrafı",
    photo_number: "Fotoğraf {number}",
    photo_cover_badge: "Kapak",
    geolocation_not_supported: "Tarayıcınız konum tespitini desteklemiyor.",
  ...
  en: {
    ...
    profile_photos_desc: "You can add as many photos as you like to complete your profile.",
    n_photos: "{count} Photos",
    main_photo: "MAIN PHOTO",
    photo_tips_title: "PERFECT PHOTO TIPS",
    tip_light: "Good Light",
    tip_solo: "Solo Shot",
    tip_face: "Clear Face",
    basic_info_title: "IDENTIFICATION INFO",
    contact_info_title: "CONTACT INFO",
    more_details_title: "A LITTLE MORE DETAIL",
    intention_title: "PURPOSE OF MEETING",
    about_me_title: "ABOUT ME",
    ai_suggestions_title: "AI SUGGESTIONS",
    hobbies_title: "INTERESTS AND HOBBIES",
    ...
    location_help_text: "Help us find people closest to you.",
