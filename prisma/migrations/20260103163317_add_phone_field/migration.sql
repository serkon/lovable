...
INSERT INTO "new_User" ("age", "bio", "city", "country", "createdAt", "educationId", "email", "genderId", "id", "intentionId", "jobId", "maritalStatusId", "password", "updatedAt") SELECT "age", "bio", "city", "country", "createdAt", "educationId", "email", "genderId", "id", "intentionId", "jobId", "maritalStatusId", "password", "updatedAt" FROM "User";
DROP TABLE "User";
